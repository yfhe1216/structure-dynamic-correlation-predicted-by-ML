...
score=title+"cuzr-dgx-beta-ridge.dat"
...
with open("propensity-beta-800K-3ps-1.dat",'r') as f:
...
f.close
with open("propensity-beta-800K-3ps-451.dat",'r') as f:
	#for i in range(0,9,1):
	#	f.readline()
	for i in range(0,natom,1):
		line=f.readline().split()
...
with open(title+"scale-param-dgx-beta-ridge.dat",'w') as sf:
